...
for idx, folder in enumerate(folder_exts):
    ...
    for temp in range(t1, t2):
        ...
        sns.scatterplot(y='resistance_ch1', x='voltage_amp_ch1', hue='current_sweep_ch1', data=df, ax=ax1, legend=False)
        # ax1.set_title('Resistance by Time')
        ax1.set_ylabel(r'$R  $', usetex=True, rotation=0)
        ax1.set_xlabel(r'$V  $', usetex=True)

        sns.scatterplot(x='ac_current_ch1', y='resistance_ch1', hue='current_sweep_ch1', data=df, ax=ax2, legend=False)
        # ax2.set_title('Resistance by Time')
        ax2.set_ylabel(r'$R  $', usetex=True, rotation=0)
        ax2.set_xlabel(r'$I  $', usetex=True)

        sns.scatterplot(y='resistance_ch1', x='b_field', hue='current_sweep_ch1', data=df, ax=ax3, legend=False)
        # ax3.set_title('Voltage by Time')
        ax3.set_ylabel(r'$R  $', usetex=True, rotation=0)
        ax3.set_xlabel(r'$B  $', usetex=True)

        sns.scatterplot(x='phase_angle_ch1', y='resistance_ch1', hue='current_sweep_ch1', data=df, ax=ax4, legend=False)
        # ax4.set_title('Resistance by Time')
        ax4.set_xlabel(r'$\phi  $', usetex=True, rotation=0)
        ax4.set_ylabel(r'$R$',usetex=True, rotation=0)

        sns.scatterplot(y='resistance_ch1', x='second_harmonic_ch1', hue='current_sweep_ch1', data=df, ax=ax5, legend=False)
        # ax5.set_title('Magnetic Field by Time')
        ax5.set_ylabel(r'$R $', usetex=True, rotation=0)
        ax5.set_xlabel(r'$2 \omega$')

        sns.scatterplot(y='resistance_ch1', x='third_harmonic_ch1', hue='current_sweep_ch1', data=df, ax=ax6, legend=False)
        # ax5.set_title('Magnetic Field by Time')
        ax6.set_ylabel(r'$R $', usetex=True, rotation=0)
        ax6.set_xlabel(r'$3 \omega$')

        sns.scatterplot(x='in_phase_voltage_ch1', y='resistance_ch1', hue='current_sweep_ch1', data=df, ax=ax7, legend=False)
        ...
        sns.scatterplot(x='quad_voltage_ch1', y='resistance_ch1', hue='current_sweep_ch1', data=df, ax=ax8, legend=False)
        ...
        sns.scatterplot(y='resistance_ch1', x='sigma_resistance_ch1', hue='current_sweep_ch1', data=df, ax=ax9, legend=True)
