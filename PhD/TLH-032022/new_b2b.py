...
for i, f1 in enumerate(files):
    ...
    volts = 1e6*medfilt(np.genfromtxt(f1, delimiter=',')[5:, 1],31)
    ...
    fitting_poly_inds = field <= B_thresh + 5
    ...
    thetas = extract_angle4(field, volts, f)
    ...
    axs[1].plot(field[:-1], thetas, c='midnightblue')
    plt.show()
