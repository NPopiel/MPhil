...
tau = median_filter(1e3 * np.genfromtxt('/Users/npopiel/Desktop/Hybrid/VT15-hybrid_21.dat'
...
ax.plot(field, func(field, alpha, beta, gamma, delta), linewidth=10, c='#BF7CDC', label='Fit',
            alpha=0.3)
ax.plot(field, alpha * field ** 2 + delta, linewidth=3, c='#982649', label='Quadratic', alpha=.8
)
...
ax.annotate(r'$H^2$ Deviation', xy=(field[dev_loc2nd], 11), xycoords='data',
                 xytext=(15.5, 12.5),
                 ha="center", va="center",
...
ax.annotate(r'Fit', xy=(24.5, 16), xycoords='data',
                 ha="left", va="center", color='#BF7CDC',
                 fontname='arial', fontsize=22)
ax.annotate(r'=', xy=(27.5, 16), xycoords='data',
                 ha="left", va="center", color='k',
            fontname='arial', fontsize=22)
ax.annotate(r'Quadratic', xy=(35, 17), xycoords='data',
                 ha="center", va="center", color='#982649',
                 fontname='arial', fontsize=22)
ax.annotate(r'+', xy=(35, 16), xycoords='data',
                 ha="center", va="center", color='k',
                 fontname='arial', fontsize=22)
ax.annotate(r'Exponential', xy=(35, 15), xycoords='data',
                 ha="center", va="center", color='#60B2E5',
                 fontname='arial', fontsize=22)
#
...
ax.annotate(r'$\phi$ = 21 $^\mathrm{o}$', xy=(43, 0), xycoords='data',
                 ha="center", va="center", color='k',
                 fontname='arial', fontsize=22)

plt.tight_layout(pad=1)
plt.show()
# fig.savefig('/Users/npopiel/Desktop/Hybrid/'+'torqueFit.pdf', bbox_inches='tight')
