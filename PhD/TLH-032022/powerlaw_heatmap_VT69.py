...
for i, f1 in enumerate(files):
    ...
    inds_list = extract_moving_indices(field,n=3.5, window_size=3.5)

    param_array = fit_powerlaw_as_function(inds_list, field, volts, plot=False)
...
plt.imshow(interpd, cmap=rdgn, aspect='auto', extent=[60, 90, B_thresh, 41.5], origin='lower')
