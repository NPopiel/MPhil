...
def get_bsqr_deviation_analytic(field, volts, N, plot=False,threshold=3):
    ...
    popt, pcov = curve_fit(func, field, volts,p0=(1,.0001,1)) #10000,0.0001,0.000000001
...
upper_Bs = 45*np.ones(5)#[30,30,26,30,30]#
...
for i, file in enumerate(files):
    ...
    B_dev_num = get_bsqr_deviation_numerically(field, volts, 500,threshold=4)
    B_dev_anal = get_bsqr_deviation_analytic(field, volts, 500,plot=False,threshold=3)
