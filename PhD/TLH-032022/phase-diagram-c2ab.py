...
np.savetxt(r'/Users/npopiel/Desktop/Hybrid/fit.csv', np.array([x_c2ab,y_c2ab]).T,delimiter=',')


fig, ax2 = MakePlot(figsize=(8,8)).create()
...
lighter_c3 =mcolors.rgb2hex(scale_lightness(mcolors.hex2color('#E05831'), 1))#'#DC3A31'
lighter_c4 =mcolors.rgb2hex(scale_lightness(mcolors.hex2color('#DC3A31'), 1))
...
ax2.scatter(angles_c2ab, B_c2ab, marker='D', s=200, edgecolor='#7E5E84', facecolor='#7E5E84',zorder=3)
ax2.errorbar(angles_c2ab, B_c2ab, yerr=err_c2ab/2, fmt='none', c='#7E5E84', linewidth=2.1,zorder=2,elinewidth=1, capsize=3)

ax2.scatter(18, 23.8, marker='D', s=200, edgecolor='#7E5E84', facecolor='#7E5E84',zorder=3)
ax2.errorbar(18, 23.8, yerr=7.34/2, fmt='none', c='#7E5E84', linewidth=2.1,zorder=2,elinewidth=1, capsize=3)
...
ax2.set_ylim(0,45)
ax2.set_xlim(-0.01,28.1)
# ax2.set_xbound(-0.3, 130)
...
#
# # Draw image
# axin = ax2.inset_axes([0.15,1,12,12],transform=ax2.transData)    # create new inset axes in data coordinates
...
ax2.annotate(r'$(110)$', xycoords='data',xy = (1.2, 13.2), arrowprops=dict(arrowstyle="->",
                            connectionstyle="arc3"),
                 ha="center", va="center", fontname='arial', fontsize=15)


# axin.annotate(r'$\phi$',
#                  xy=(290, 156),xycoords='data',
