...
for i, file in enumerate(files):
    ...
    ax.plot(field[zoom_inds], np.log(volts)[zoom_inds], c=plt.cm.jet(i/len(files)), linewidth=2, label=angles[i])

publication_plot(ax, 'B', r'$\log(\tau)$')
