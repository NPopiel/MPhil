...
ute2_crystal_path = '/Volumes/GoogleDrive/My Drive/UTe2.png'#'/Users/npopiel/Desktop/UTe2-crystal.png'
...
legend = ax1.legend(handles[::-1], labels[::-1], framealpha=0, ncol=1, loc='upper right',
              prop={'size': 22, 'family': 'arial'}, handlelength=0)#, bbox_to_anchor=(27.5,12.5), bbox_transform=ax1.transData)
