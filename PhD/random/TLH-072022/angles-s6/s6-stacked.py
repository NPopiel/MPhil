...
a4 = fig.add_subplot(gs[3, :3])
a5 = fig.add_subplot(gs[4, :3])
a6 = fig.add_subplot(gs[5, :3])
a7 = fig.add_subplot(gs[6, :3])
a8 = fig.add_subplot(gs[7, :3])

axs = [a1, a2, a3, a4, a5, a6, a7, a8]
