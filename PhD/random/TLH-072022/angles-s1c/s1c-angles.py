...
colours = ['#3bcfd4','#6CC0A1','#9CB16D','#CCA239','#E49B1F','#FC9305','#FA6F29','#F74A4D','#F52571','#F20094']#'#CCA239'4th,'#FC9305',6th
...
for i, filename in enumerate(filenames):
        ...
        ax1.plot(new_field, subtracted_tau * 1e6 + i*.59, linewidth=1.4, c=colours[i], label = str(angles[i])+r'$\degree$')
        ax2.plot(fft_x / 1e3, 1.4*fft_y / np.max(fft_y) + i * 1.2, linewidth=1.8, c=colours[i])
...
axin = ax3.inset_axes([10, 9.5, 52, 3.6], transform=ax3.transData)  # create new inset axes in data coordinates
...
publication_plot(ax3, r'$\phi$ ($\degree$)', r'Frequency (kT)')


ax3.annotate(r'$T = 30$ mK ', xy=(0.14, 0.03), xycoords='axes fraction',
             ha="center", va="center", fontname='arial', fontsize=20)

ax3.annotate(r'$90 \degree\approx\mathbf{H}\parallel[010]$', xy=(0.9, 0.9), xycoords='axes fraction',
             ha="right", va="center", fontname='arial', fontsize=20)

ax3.annotate(r'$0 \degree\approx\mathbf{H}\parallel [001]$', xy=(0.9, 0.95), xycoords='axes fraction',
             ha="right", va="center", fontname='arial', fontsize=20)



plt.tight_layout(pad=1.5)
# plt.savefig('/Volumes/GoogleDrive/Shared drives/AGE_JRF/Magnet times/TLH_SCM4_Jul22/Figs/angles-s1c-adjusted.png', dpi=300)
plt.show()
