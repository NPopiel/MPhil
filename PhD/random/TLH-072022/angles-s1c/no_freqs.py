...
ax2.set_ybound(-0.5, 4.75)

# ax2.set_xbound(25,28)
# ax2.set_xticks([25, 26,27,28])

ax3.set_ybound(-0.02,7.5)
ax3.set_xbound(0,10)
...
for line, text in zip(legend.get_lines(), legend.get_texts()):
    ax2.annotate(labels[::-1][k], xy=(0.95, 4.1-k*spacing), xycoords=('axes fraction', 'data'),
                 ha="center", va="center", fontname='arial', fontsize=22, color=line.get_color())
...
ax1.annotate(r'$\phi = 78 \degree$', xy=(0.35, 0.1), xycoords='axes fraction',
             ha="left", va="center", fontname='arial', fontsize=20)
...
plt.savefig('/Volumes/GoogleDrive/Shared drives/AGE_JRF/Magnet times/TLH_SCM4_Jul22/Figs/new_figs/c2b-w-mega-v3.pdf'
