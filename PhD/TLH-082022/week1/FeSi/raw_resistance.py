...
sweeps = ['0.35K_30deg_sweep016_down.csv', # I = 1 uA
    '0.35K_30deg_sweep015_up.csv', # I = 1 uA
'0.35K_37deg_sweep017_up.csv', # I = 1 uA
'0.35K_37deg_sweep018_down.csv', # I = 1 uA
    '0.35K_50deg_sweep012_down.csv', # I = 1 uA
            '0.35K_50deg_sweep011_up.csv', # I = 1 uA
         '0.35K_70deg_sweep007_down.csv', # I = 1 uA
          '0.35K_70deg_sweep006_up.csv', # I = 1 uA
          '0.35K_90deg_sweep004_down.csv' # I = 1 uA
          ]

currents = [1e-6, 1e-6, 1e-6, 1e-6, 1e-6, 1e-6, 1e-6, 1e-6, 1e-6]



angles = [30, 30, 37, 37, 50, 50, 70, 70, 90]
