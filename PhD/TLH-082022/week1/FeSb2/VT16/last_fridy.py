...
torque_path = '/Volumes/GoogleDrive/Shared drives/Quantum Materials/MagnetTime/2022_08_TLH/week2_torque/VT16/'
...
sweeps = [#'0.35K_90deg_sweep004_down.csv', # ON AH
    '0.35K_70deg_sweep008_up.csv',# ON GR, 100 V
    '0.35K_70deg_sweep009_down.csv',# ON GR, 100 V
    '0.35K_50deg_sweep011_up.csv',# ON GR, 100 V
    '0.35K_50deg_sweep012_down.csv',# ON GR, 100 V
    '0.35K_30deg_sweep015_up.csv',  # ON GR, 100 V
'0.35K_30deg_sweep016_down.csv',  # ON GR, 100 V,
'0.35K_37deg_sweep017_up.csv',
    '0.35K_37deg_sweep018_down.csv',# ON GR, 100 V
    '0.35K_37deg_sweep020_up.csv',# ON GR, 100 V
'0.35K_37deg_sweep021_down.csv',# ON GR, 100 V,
'0.35K_37deg_sweep022_up.csv',# ON GR, 100 V
'0.35K_37deg_sweep023_down.csv'# ON GR, 100 V
    ]

lstyles = ['solid', 'dashed']

angles = [70, 70, 50, 50, 30, 30, 37, 37, 37]
...
ax3.annotate('VT16',xy=(0.1, 0.95), xycoords='axes fraction',
