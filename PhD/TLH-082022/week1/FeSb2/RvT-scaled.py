...
ax1.scatter(T_VT16, R_VT16/np.min(R_VT16), label='VT16', s=40, c=cmap[0])
ax1.scatter(T_VT69, R_VT69/np.min(R_VT69), label='VT69', s=40, c=cmap[7])
ax1.scatter(T_VT54, R_VT54/np.min(R_VT54), label='VT54', s=40, c=cmap[4])
ax1.scatter(T_VT154, R_VT154/np.min(R_VT154), label='VT154', s=40, c=cmap[3])
ax1.scatter(T_VT166, R_VT166/np.min(R_VT166), label='VT166', s=40, c=cmap[5])
...
publication_plot(ax1, 'Temperature (K)', r'Resistance ($\Omega$)', x_ax_log=True)

# ax1.set_ylim(-0.01, 5e6)


plt.tight_layout(pad=3)
# plt.show()
plt.savefig(main_path+'not-log-RvT.png', dpi=300, bbox_inches='tight')