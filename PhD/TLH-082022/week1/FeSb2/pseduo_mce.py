...
dat_22 = pd.read_csv('/Volumes/GoogleDrive/Shared drives/Quantum Materials/MagnetTime/2022_08_TLH/week2_torque/All Sweeps/Cambridge_2022_Sep.022.txt',
...
T_22, B_22 = load_temps(dat_22,'022')

dat_23 = pd.read_csv('/Volumes/GoogleDrive/Shared drives/Quantum Materials/MagnetTime/2022_08_TLH/week2_torque/All Sweeps/Cambridge_2022_Sep.023.txt',
                  delimiter='\t', skiprows=9)


T_23, B_23 = load_temps(dat_23,'023',up=False)
