...
torque_path = '/Volumes/GoogleDrive/Shared drives/Quantum Materials/MagnetTime/2022_08_TLH/week1/FeGa3-VLS1/reload/AH/'
...
for i, s_name in enumerate(sweeps):
    ...
    torque_dat = load_matrix(torque_path + '0.29K_103.33deg_sweep093_down.csv')
    field = torque_dat[:, 0]
    tau = torque_dat[:, 1]
