...
ax2.plot(new_field[l1], subtracted_tau[l1]*1e5, c='#113537', linewidth=1.2)
ax2.plot(new_field[l2], subtracted_tau[l2]*1e5, c='#113537', linewidth=1.2)
...
subtracted_tau = new_tau - fit_tau
ax3.plot(new_field, subtracted_tau*1e6, c='#FF47DA', linewidth=1.2)
...
# Draw image
axin = ax1.inset_axes([0.65, 0.01, 0.23, 0.23])  # create new inset axes in data coordinates
...
ax2.annotate(r'$T = 350$ mK', xy=(0.15, 0.88), xycoords='axes fraction',
              ha="left", va="center", fontname='arial', fontsize=22)

ax4.annotate(r'$30 < \mu_0H < 38.8$ T', xy=(0.16, 0.88), xycoords='axes fraction',
              ha="left", va="center", fontname='arial', fontsize=14)

ax5.annotate(r'$36 < \mu_0H < 38.8$ T', xy=(0.16, 0.88), xycoords='axes fraction',
              ha="left", va="center", fontname='arial', fontsize=14)
...
publication_plot(ax2, r'', r'$\Delta \tau$ ($\times 10^{-2}$ mV)')
...
plt.savefig('/Volumes/GoogleDrive/Shared drives/Quantum Materials - Sebastian Group/MagnetTime/2022_10_TLH/week2/wiggles-V.png',
