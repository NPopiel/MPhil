...
temperatures = [0.46, 0.75, 1.45, 1.95]  # These are definitely wrong and mass is much heavier as a consequence
freq1 = np.array([0.00786, 0.005864, 0.00536, 0.0042, ])
# freq2 = np.array([0.001248,])
freq2 = np.array([0.00459, 0.00304, 0.00123, 0.0001, None])
...
ax1.scatter(temperatures_K, freq2,facecolor='none', edgecolor='r', s=1000)
