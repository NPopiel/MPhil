...
x1, x2, y1, y2 = 30, 38.8, tau[locs][0], tau[locs][-1]
...
axins.plot(field[locs], 1e4*d_tau[locs], linewidth=1.5, c='#592E83', label=str(14)+r'$\degree$')
...
publication_plot(axins, r'$\mu_0H$ (T)', r'$\frac{\partial \tau}{\partial B}$ ($\times 10^{-4}$ pF T$^{-1})      $', tick_fontsize=14, label_fontsize=16)
...
plt.savefig('/Volumes/GoogleDrive/Shared drives/Quantum Materials - Sebastian Group/MagnetTime/2022_10_TLH/week2/wiggles-pF.png',
