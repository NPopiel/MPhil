...
def lifshitz_kosevich(temps, e_mass, amp, field=36.8885397):
    kb = 1.380649e-23
    me = 9.1093837015e-31
...
temperatures = [0.46, 0.75, 1.45, 1.95, 3.2]  # These are definitely wrong and mass is much heavier as a consequence
freq1 = np.array([0.0083, 0.00587, 0.00531, 0.00308, 0.00256])
# freq2 = np.array([0.001248,])

temperatures_2 = [0.46, 0.75, 1.45, 1.95]
freq2 = np.array([0.00459, 0.00304, 0.00123, 0.0001])
...
popt2, pcov2 = scipy.optimize.curve_fit(lifshitz_kosevich, temperatures_2, freq2, p0=(60, 2.3515721812642054e-05))

perr1 = np.sqrt(np.diag(pcov1))
perr2 = np.sqrt(np.diag(pcov2))

oversampled_temps = np.linspace(0.0001, 8, 10000)
...
ax1.scatter(temperatures_K, freq1, c='r', s=1000)
ax1.scatter(temperatures_2, freq2,facecolor='none', edgecolor='r', s=1000)
