...
filenumbers_up = ['122', '125', '128']

filenumbers_dn = ['123', '126', '129']
...
field_root = 'Field_'
Volts_xx_root = 'VT166_Rxx_X_'
Volts_xy_root = 'VT166_Rxy_X_'
...
for i, s_num in enumerate(filenumbers_up):
    ...
    ax1.plot(B, Rxx, linewidth=2, c=colours[i], label=str(angles[i])+r'$\degree$')
    ax2.plot(B, Rxy, linewidth=2, c=colours[i], label=str(angles[i])+r'$\degree$')
