...
Is = [10e-6, 10e-6, 10e-6, 10e-6, 10e-6, 10e-6]
...
for i, s_num in enumerate(filenumbers):
    ...
    ax1.plot(B, Rxx, linewidth=2, c=colours[i], label=str(I)+r' A')
    ax2.plot(B, Rxy, linewidth=2, c=colours[i], label=str(I) + r' A')
