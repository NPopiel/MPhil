...
field_7 = dat7['Field_033']
coil_X_7 = dat7['Coil_X_033']
coil_Y_7 = dat7['Coil_Y_033']
coil_R_7 = dat7['Coil_R_033']

dat8 = pd.read_csv(main_path + 'Cambridge_October.049_Up.csv')
field_8 = dat8['Field_049']
coil_X_8 = dat8['Coil_X_049']
coil_Y_8 = dat8['Coil_Y_049']
coil_R_8 = dat8['Coil_R_049']


field_6, coil_Y_6 = load_xy(main_path+file_6, '056',x_root='Field_', y_root='Coil_Y_',skiprows=14)
field_6, coil_X_6 = load_xy(main_path+file_6, '056', x_root='Field_',y_root='Coil_X_',skiprows=14)
angles_6, coil_R_6 = load_xy(main_path+file_6, '056', x_root='Field_',y_root='Coil_R_',skiprows=14)



ax1.plot(field_8, coil_Y_8, linewidth=2, c=colours[1], label='$T = 25$ mK')
ax1.plot(field_7, coil_Y_7, linewidth=2, c=colours[4], label='$T = 90$ mK')

ax1.plot(field_6, coil_Y_6, linewidth=2, c=colours[6], label='$T = 500$ mK')
...
plt.savefig(main_path+'temps-fig.png', dpi=300)
plt.show()
