...
field_8, coil_Y_8 = load_xy(main_path+file_8, '049',x_root='Field_', y_root='Coil_Y_',skiprows=9)
field_8, coil_X_8 = load_xy(main_path+file_8, '049', x_root='Field_',y_root='Coil_X_',skiprows=9)
angles_8, coil_R_8 = load_xy(main_path+file_8, '049', x_root='Field_',y_root='Coil_R_',skiprows=9)


ax1.plot(field_1, coil_X_1, linewidth=2, c=colours[0], label='Up 1')
ax1.plot(field_2, coil_X_2, linewidth=2, c=colours[1], label='Down 1')
ax1.plot(field_3, coil_X_3, linewidth=2, c=colours[2], label='Up 2')
ax1.plot(field_4, coil_X_4, linewidth=2, c=colours[3], label='Down 2')
ax1.plot(field_5, coil_X_5, linewidth=2, c=colours[4], label='Up 3')
ax1.plot(field_6, coil_X_6, linewidth=2, c=colours[5], label='Down 3')
ax1.plot(field_7, coil_X_7, linewidth=2, c=colours[6], label='Long 1')
ax1.plot(field_8, coil_X_8, linewidth=2, c=colours[7], label='Long 2')
