...
field_3, coil_Y_3 = load_xy(main_path+file_2, '053',x_root='Field_', y_root='Coil_Y_',skiprows=9)
field_3, coil_X_3 = load_xy(main_path+file_2, '053', x_root='Field_',y_root='Coil_X_',skiprows=9)
angles_3, coil_R_3 = load_xy(main_path+file_2, '053', x_root='Field_',y_root='Coil_R_',skiprows=9)
...
H, T = torque_integrator(interpd_field, interpd_X_up)
ax1.plot(H, T*1e7, linewidth=2, c=colours[3], label='Torque from Integrated AC 90 Hz')
