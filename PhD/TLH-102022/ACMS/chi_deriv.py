...
deriv1 = savgol_filter(coil_X_1, window, poly, deriv=1)
...
deriv2 = savgol_filter(coil_X_2, window, poly, deriv=1)
...
deriv3 = savgol_filter(coil_X_3, window, poly, deriv=1)
...
deriv4 = savgol_filter(coil_X_4, window, poly, deriv=1)
...
deriv5 = savgol_filter(coil_X_5, window, poly, deriv=1)
...
deriv6 = savgol_filter(coil_X_6, window, poly, deriv=1)
...
deriv7 = savgol_filter(coil_X_7, window, poly, deriv=1)


ax1.plot(field_1, deriv1, linewidth=2, c=colours[0], label='Up 1')
ax1.plot(field_2, deriv2, linewidth=2, c=colours[1], label='Down 1')
ax1.plot(field_3, deriv3, linewidth=2, c=colours[2], label='Up 2')
ax1.plot(field_4, deriv4, linewidth=2, c=colours[3], label='Down 2')
ax1.plot(field_5, deriv5, linewidth=2, c=colours[4], label='Up 3')
ax1.plot(field_6, deriv6, linewidth=2, c=colours[5], label='Down 3')
ax1.plot(field_7, deriv7, linewidth=2, c=colours[6], label='Long')




publication_plot(ax1, r'$\mu_0 H$ (T)', r'$\frac{d\chi}{dB}$')#^\prime
