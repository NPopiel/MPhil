...
curr_900 = ['VT64_1p75K900uA.csv',
            'VT64_2p0K900uA.csv',
            'VT64_2p25K900uA.csv',
            'VT64_2p5K900uA.csv']#, I think fit starts breaking here.. do by hand
            #'VT64_3p25K900uA.csv',
            #'VT64_3p5K900uA.csv',
            #'VT64_3p75K900uA.csv',
            #'VT64_4p0K900uA.csv']
...
ax.set_title(r'900 $\mu A$', fontsize=32,fontname='arial')
...
plt.tight_layout()
#plt.show()
plt.savefig('/Volumes/GoogleDrive/My Drive/Thesis Figures/Transport/VT64_delta-G-900uA-draft1.png', bbox_inches='tight',dpi=400)