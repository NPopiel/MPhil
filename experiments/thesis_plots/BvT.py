...
ax.scatter(B800_neg,temps_800,  c='r', marker='*')
...
ax.scatter(B900_neg, temps_900, c='darkgreen', marker='*')
...
plt.savefig('/Volumes/GoogleDrive/My Drive/Thesis Figures/Transport/TvBcrit.png', dpi=300)
plt.show()
