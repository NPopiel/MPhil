...
for ind, curr_data_name in enumerate(data_sets):
    ...
    for idx, current_temp_data_name in enumerate(curr_data_name):
        ...
        ffit_down_pos, B1, B2, area, small_locs = fit_wo_step(resistance_down_pos, field_down_pos,return_field=True,
                                                              return_area=True,return_shortened_locs=True,
                                                              num_pts=1,polyorder=3,deg=1)
        ...
        ffit_up_neg, B1, B2, area, small_locs = fit_wo_step(resistance_up_neg, field_up_neg, return_field=True,
                                                            return_area=True, return_shortened_locs=True,
                                                            num_pts=2,polyorder=3,deg=1)
        ...
        ffit_down_neg, B1, B2, area, small_locs = fit_wo_step(resistance_down_neg, field_down_neg, return_field=True,
                                                              return_area=True, return_shortened_locs=True,
                                                              num_pts=2,polyorder=3,deg=1)
