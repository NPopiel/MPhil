...
temps_800 = [1,75, 2,2.25,2.5,2.75,3]
...
ax.set_ylabel(r'$\langle |\Delta G| \rangle$ $\frac{e^2}{h}$',fontname='arial',fontsize=24)


plt.savefig('/Volumes/GoogleDrive/My Drive/Thesis Figures/Transport/linear_trend_maxima_dG.png', dpi=300)
#plt.show()
