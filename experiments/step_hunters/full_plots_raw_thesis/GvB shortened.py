...
for ind, curr_data_name in enumerate(data_sets):
    ...
    axes[ind].axhline(1/607/flux_quantum,c='k', alpha=0.36, linestyle='dashed')
...
#plt.tight_layout()
plt.savefig('/Volumes/GoogleDrive/My Drive/Thesis Figures/Transport/step-small-conductance.pdf',dpi=400)
#plt.show()
#plt.close()
