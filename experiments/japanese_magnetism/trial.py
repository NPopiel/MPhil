...
ax.plot(np.array(temps),1/np.array(slopes_fc),  linewidth=2.5, c='r', marker='o', label=r'$\frac{1}{\chi}$')
...
ax2 = ax.twinx()
ax2.plot(np.array(temps),np.array(slopes_fc),linewidth=2.5, c='k', marker='o', label=r'$\chi$')
